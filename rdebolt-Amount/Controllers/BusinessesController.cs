...
namespace rdebolt_Amount.Controllers
{
    public class BusinessesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location")] Business business)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location")] Business business)
        {
            if (id != business.Id)
            {
                return NotFound();
